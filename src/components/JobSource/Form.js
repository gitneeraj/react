                    ...
                    <div className="modal-body">
                        <div className="row">
                            ...
                            <div className="col-lg-12">
                                <Field 
                                    name="fetcher_details" 
                                    component={renderTextArea} 
                                    label="Details of content to be fetched" 
                                />
                            </div>
                            <div className="col-lg-12">
                                <Field 
                            ...
                            <div className="col-lg-6">
                                <label className="control-label supporting-label">
                                    How do you want the content to be delivered?
                                </label>
                                <div className="radio">
                            ...
                            <div className="col-lg-6">
                                <label className="control-label supporting-label">
                                    How often do you want to scrape?
                                </label>
                                <div className="radio">
                                    <label className="form-label">
                                        <Field 
